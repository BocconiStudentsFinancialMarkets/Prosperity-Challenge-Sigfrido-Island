...
# Updated Position Limits: includes Round 1 and Round 2 products
POSITION_LIMITS = {
    'RAINFOREST_RESIN': 50,
    'KELP': 50,
    'SQUID_INK': 50,
    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            for ask_price, ask_volume in sorted(sell_orders.items()):
                # Ensure position limits are respected for each product
                position_limit = POSITION_LIMITS.get(product, POSITION_LIMITS['RAINFOREST_RESIN'])
